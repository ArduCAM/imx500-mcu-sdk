...
the Raspberry Pi 5 example adds a Linux-hosted path with MIPI preview and
metadata access through `i2c-dev`/`spidev`.
...
| Validate Raspberry Pi 5 metadata | [rpi5](rpi5/README.md) | Raspberry Pi 5 previews over MIPI and reads metadata over Linux SPI |
