...
from camera_serial_stream_common.renderers import ClassificationRenderer
from metadata_bridge import adapt_metadata_to_networks

MODEL_DIR = REPO_ROOT / "tools" / "assets" / "models" / "mobilenet_v2"
MODEL_INFO = load_model_info(MODEL_DIR)
RENDERER = ClassificationRenderer()


def annotate_frame(parsed_frame, _args):
    return RENDERER.render(parsed_frame.image_bgr, adapt_metadata_to_networks(parsed_frame))
