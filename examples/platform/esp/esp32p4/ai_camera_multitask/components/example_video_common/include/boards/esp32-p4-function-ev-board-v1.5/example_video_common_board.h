 ...
 */
#define EXAMPLE_MIPI_CSI_SCCB_I2C_SCL_PIN               1
#define EXAMPLE_MIPI_CSI_SCCB_I2C_SDA_PIN               0
...
#define EXAMPLE_MIPI_CSI_CAM_MOTOR_SCCB_I2C_SCL_PIN     1
#define EXAMPLE_MIPI_CSI_CAM_MOTOR_SCCB_I2C_SDA_PIN     0
